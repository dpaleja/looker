view: qrpt_bscharge_fcby_csfor_web_bi {
  sql_table_name: dbo.qrptBSChargeFCByCSForWebBI ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, customer_services.id, customer_services.name, customer_unit.id, customer_unit.name]
  }
}
