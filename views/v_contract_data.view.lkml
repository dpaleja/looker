view: v_contract_data {
  sql_table_name: dbo.vContractData ;;
  drill_fields: [id]
  ...
  dimension: contract_attribute1 {
    type: string
    sql: ${TABLE}.ContractAttribute1 ;;
  }

  dimension: contract_attribute2 {
    type: string
    sql: ${TABLE}.ContractAttribute2 ;;
  }

  dimension: contract_attribute3 {
    type: string
    sql: ${TABLE}.ContractAttribute3 ;;
  }

  dimension: contract_attribute4 {
    type: string
    sql: ${TABLE}.ContractAttribute4 ;;
  }

  dimension: contract_attribute5 {
    type: string
    sql: ${TABLE}.ContractAttribute5 ;;
  }

  dimension: contract_attribute6 {
    type: string
    sql: ${TABLE}.ContractAttribute6 ;;
  }
