view: customer_services {
  sql_table_name: dbo.CustomerServices ;;
  drill_fields: [id]
  ...
  dimension: has_transferred {
    type: string
    sql: ${TABLE}.HasTransferred ;;
  }
  ...
  dimension: transfer_bsid {
    type: number
    value_format_name: id
    sql: ${TABLE}.TransferBSID ;;
  }
  ...
  set: detail {
    fields: [
      ...
      usage_set.id,
      usage_set.name,
      customer_service_charge.count,
      customer_service_charge_fc.count,
      qrpt_bscharge_all_by_csfor_web_bi.count,
      qrpt_bscharge_fcby_csfor_web_bi.count,
      usage_set_bscharges.count,
      v_customer_service_monthly_base_cost_with_transfer.count,
      v_customer_service_monthly_charge.count,
      v_customer_service_monthly_cost.count,
      v_customer_service_monthly_cost_with_no_expense.count,
